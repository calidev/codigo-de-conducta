# [calidev] - Código de Conducta

## 1. Propósito

Uno de los objetivos principales de `calidev` es ser inclusiva para el 
...
Invitamos a todos los que participan en `calidev` a que nos ayuden a crear
...
En la comunidad `calidev` nos esforzamos por ir un paso más allá y cuidar 
...
hacer que sus compañeras y compañeros de `calidev` estén cómodos.
...
[Adaptado del CoC de Colombia Dev](https://github.com/colombia-dev/codigo-de-conducta)
...
- [@calidevco](https://twitter.com/calidevco)
